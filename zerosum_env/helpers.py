...
class Point(tuple):
    ...
    def to_index(self, size: int):
        """
        Converts a 2d position in the form (x, y) to an index in the observation.carbon list.
    ...
    def from_index(index: int, size: int) -> 'Point':
        """
        Converts an index in the observation.carbon list to a 2d position in the form (x, y).

...
import traceback
from typing import *
from zerosum_env import errors, utils
from zerosum_env.agent import Agent
from zerosum_env.core import environments, evaluate, make
...
def action_http(args):
    ...
    app = Flask(__name__, static_url_path="/zerosum_env", static_folder="")
